...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/mkbuild
   cd mkbuild
   ```
...
```sh
https://github.com/flex-development/mkbuild/compare/main...$branch
```
...
[19]: https://github.com/flex-development/mkbuild/discussions/new?category=q-a
